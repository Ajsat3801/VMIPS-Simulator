...
class Core():
    ...
    # Vector Operations
    # TO DO: 
    # 1) Add masks to all the operations
    ...
    def execute_LV(self,instr_list): 
        ...
        for i in range(VLR): 
            if VMR[i] == 1: VR1[i] = self.VDMEM.Read(SR1+i)
    ...
    def execute_SV(self,instr_list): 
        ...
        for i in range(VLR):
            if VMR[i] == 1: self.VDMEM.Write(SR1 + i, VR1[i])
        return 0
